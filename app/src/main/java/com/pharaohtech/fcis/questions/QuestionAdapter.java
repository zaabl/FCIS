...
public class QuestionAdapter extends FirestoreRecyclerAdapter<Post, QuestionAdapter.PostHolder> {
    /**
     ...
     * @param options
     */
    public QuestionAdapter(@NonNull FirestoreRecyclerOptions<Post> options) {
        super(options);
    }
